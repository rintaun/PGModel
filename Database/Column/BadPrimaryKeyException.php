<?php
namespace PGModel\Database\Column;

class BadPrimaryKeyException extends BadColumnException {
    /**
     * BadPrimaryKeyException constructor
     *
     * Creates a new BadPrimaryKeyException, which is like a regular
     * column exception, except that the column *may* exist, but it is not
     * a primary key in any case. It generates an error message if
     * required.
     *
